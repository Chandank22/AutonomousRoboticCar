...
; export symbols
            ...
            XDEF HILO0_init, HILOtimes0
            XDEF get_HI_time0, get_LO_time0
...
;###################################################################################################################
 ...
 ; calc HI-LO times of pulse train on Ch 0 
;   and store results in HI_time0 and LO_time0            
...
HILO0_init:
            ...
            movb  #$80,TSCR1  ;enable timer
            ldd   TCNT
            std   TC0 				;init cnt in TC0
            bset  TCTL4,#$03  ;interrupt on both edges of Ch 0
						movb  #$01,TFLG1  ;clear any old flag on Ch 0
            bset  TIE,#$01    ;enable TC0 interrupts
            cli               ;enable interrupts
						rts

; calc HI-LO times of pulse train on Ch 0 
;   and store results in HI_time0 and LO_time0            
; void getHILOtimes0(void);
HILOtimes0:
						brclr PTT,$01,HL01 ;if PTT0 is hi, rising edge
						ldd   TC0
						pshd              ;save TC0
						subd  TC0old      ;LO_time'
            std   LO_time0;   ;store LO_time0
            puld              ;get TC0
            std   TC0old;     ;TC0old = TC0
            bra   HL02
HL01:       ldd   TC0					;else, falling edge
						pshd              ;save TC10
						subd  TC0old      ;HI_time'
            std   HI_time0;   ;save HI_time0
            puld              ;get TC0
            std   TC0old;     ;TC0old = TC0
HL02:       bset  TFLG1, #$01 ;clear int flag            
            rts
